estado_animo = { 
    # Diccionario de emociones básicas que permite al sistema asociar palabras clave 

    "feliz": ["feliz", "contento", "alegre", "genial", "entusiasmado", "emocionado"],
    "triste": ["triste", "deprimido", "mal", "solo", "vacío", "llorando"],
